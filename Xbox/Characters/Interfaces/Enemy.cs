...
namespace AscianXbox
{
    public abstract class Enemy : DrawableGameComponent
    {
        ...
        public delegate void AI(object data);
        ...
        protected AI ai;
        public int vector_polarity_x;  //+1, -1, 0 (neutral)
        public int vector_polarity_y;  //Used to determine enemy move direction vector
        ...
        protected void normalAI(object data)
        {
            findPlayer();
            followPlayer();
        }
