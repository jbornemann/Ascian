...
namespace Ascian
{
    public class Upgrade : DrawableGameComponent
    {
        ...
        public Upgrade(Dictionary<String, Texture2D[]> texPack, Texture2D overlay, Texture2D defaultSelection, Player player, ref global_vars vars, ref Game1 game) : base(game)
        {
            ...
            selectionDelay = new Timer(vars.UPGRADE_DELAY);
            selectionDelay.Elapsed += new ElapsedEventHandler(selectDelay);
        }
        ...
        void selectDelay(object sender, ElapsedEventArgs e)
        {
            selectReady = true;
            selectionDelay.Stop();
        }
